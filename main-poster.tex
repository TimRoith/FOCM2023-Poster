...
\usepackage[institute=FAU,
			WordMark = template-art/TU-Berlin-Logo.svg,
		    SecondLogo = atelier/UMN2.png,
            ThirdLogo = template-art/FAUWortmarkeBlau.pdf,
            FirstLogoFactor=0.3,
            SecondLogoFactor=0.55,
            ThirdLogoFactor=0.5,
            WordMarkRight=None,
		    size=a0,
...
\input{sections/GConv.tex}
\input{sections/AMLE.tex}
\input{sections/bottom.tex}%
%
\end{frame}
\end{document}